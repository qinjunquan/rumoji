...
module Rumoji
  class Emoji
    OBJECTS = Set[
      ...
      self.new("\u{25fc}", [:black_medium_square]),
      self.new("\u{25fb}", [:white_medium_square]),
      self.new("\u{25fe}", [:black_medium_small_square]),
      self.new("\u{25fd}", [:white_medium_small_square]),
      self.new("\u{2b1c}", [:white_large_square]),
      self.new("\u{2b1b}", [:black_large_square]),
      self.new("\u{25ab}", [:white_small_square]),
      self.new("\u{25aa}", [:black_small_square]),
      self.new("\u{1f519}", [:back]),
      self.new("\u{1f4e6}", [:package]),
      self.new("\u{1f4d6}", [:book]),
      self.new("\u{2747}", [:sparkle]),
      self.new("\u{1f508}", [:speaker]),
      self.new("\u{1f320}", [:starts]),
      self.new("\u{1f4e9}", [:email])
    ]
  end
end
